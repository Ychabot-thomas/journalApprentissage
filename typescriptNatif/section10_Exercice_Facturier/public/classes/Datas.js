    ...
    htmlFormat() {
      ...
      <div class="row p-5">
        ...
        <div class="col-md-6 text-right">
            <p class="font-weight-bold mb-1">${this.documentType === "invoice" ? "Facture N°" : "Devis N°"}<span class="font-weight-normal">${Math.floor(Math.random() * 101)}</span></p>
            <p class="font-weight-bold mb-1">Date <span class="font-weight-normal">${this.date.toUTCString()}</span></p>
        </div>
      </div>
        ...
        <div class="col-md-12">
          <table class="table">
            ...
            <tbody>
              ...
              <td>${this.price} € HT</td>
              <td>${this.quantity}</td>
              <td>${this.quantity * this.price} € HT</td>
              </tr>
            </tbody>
          </table>
        </div>
